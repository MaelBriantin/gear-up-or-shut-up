...
export const OptionsInterface = () => {
    ...
    return (
        <div
            ...
            <div 
                className={`hover:opacity-100 ${displayOptions ? 'opacity-100' : 'opacity-20'} group flex justify-center items-center px-4 rounded-[4px] h-8 bg-zinc-800 text-white dark:bg-white dark:text-black cursor-pointer text-xl`}
